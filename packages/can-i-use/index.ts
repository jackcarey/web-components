...
class CanIuseComponent extends HTMLElement {
  ...
  #render(): void {
    if (!this.#root) return;
    this.#root.innerHTML = `<iframe src="https://caniuse.bitsofco.de/embed/index.html?feat=${this.feature}&periods=${this.periods}&accessible-colours=${this.accessibleColours?"true":"false"}" frameborder="0" width="100%" height="400px"></iframe>
        <picture>
        <source type="image/webp" srcset="https://caniuse.bitsofco.de/image/${
          this.feature
        }.webp">
        <source type="image/png" srcset="https://caniuse.bitsofco.de/image/${
          this.feature
        }.png">
