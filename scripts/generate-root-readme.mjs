...
const mdHeader = `# web-components\n\n## This repo is currently a work-in-progress.\n\n![update_publish workflow](${badgeUrl})\n\nThis is a collection of ${count} web components for various purposes. **Each component is published as a separate package with its own readme and license**. The 'autoloader' can be used to load other components. \n\n`;
