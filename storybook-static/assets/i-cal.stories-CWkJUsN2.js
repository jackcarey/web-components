import{C as H}from"./utils-BrIMlTgq.js";import{k as T}from"./index-CLeWWfmH.js";import"./iframe-BJlIPn71.js";import"../sb-preview/runtime.js";const e=`BEGIN:VCALENDAR
VERSION:2.0
CALSCALE:GREGORIAN
BEGIN:VEVENT
...
END:VALARM
END:VEVENT
END:VCALENDAR`,te={...H("i-cal")},s={args:{}},t={args:{events:e}},a={args:{src:"https://raw.githubusercontent.com/jackcarey/web-components/master/packages/i-cal/example.ics",refresh:360}},n={args:{src:"https://doesnotexist.example.com/calendar.ics"}},o={args:{events:e,locales:"en-GB"}},c={args:{events:e,locales:"ko-KR"}},J=`
i-cal#styled{
...
i-cal#styled::part(location)::before { content: "📍" }`,l={args:{events:e},render:r=>T`<style>
                ${J}</style
            ><i-cal id="styled" events=${r.events}></i-cal>`},i={args:{events:e,locales:"en-GB"},render:r=>T`<i-cal id="custom" events=${r.events} locales="${r.locales}">
            <template>
                <style>
                    * {
                        list-style: none;
        ...
        </i-cal>`},m={args:{events:e},render:r=>T`<i-cal id="children" events=${r.events}>
            <h1>Other Children</h1>
        </i-cal>`},p={args:{events:e,since:"1970-01-01"}},E={args:{events:e,until:"1970-01-01"}},d={args:{events:e,since:"1950-01-01",until:"1990-01-01"}};var I,N,S;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {}
}`,...(S=(N=s.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};var A,D,u;t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    events: exampleICS
  }
...
}`,...(M=(O=o.parameters)==null?void 0:O.docs)==null?void 0:M.source}}};var V,L,B;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    events: exampleICS,
    locales: "ko-KR"
  }
}`,...(B=(L=c.parameters)==null?void 0:L.docs)==null?void 0:B.source}}};var G,x,P;l.parameters={...l.parameters,docs:{...(G=l.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    events: exampleICS
  },
...
}`,...(P=(x=l.parameters)==null?void 0:x.docs)==null?void 0:P.source}}};var k,U,w;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    events: exampleICS,
    locales: "en-GB"
  },
...
}`,...(w=(U=i.parameters)==null?void 0:U.docs)==null?void 0:w.source}}};var Y,F,b;m.parameters={...m.parameters,docs:{...(Y=m.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    events: exampleICS
  },
...
}`,...(z=(q=d.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};const ae=["Default","FixedEvents","FetchEvents","FetchError","BritishLocale","KoreanLocale","ExternalStyles","CustomTemplate","OtherChildren","Since1970","Until1970","Between1950And1990"];export{d as Between1950And1990,o as BritishLocale,i as CustomTemplate,s as Default,l as ExternalStyles,n as FetchError,a as FetchEvents,t as FixedEvents,c as KoreanLocale,m as OtherChildren,p as Since1970,E as Until1970,ae as __namedExportsOrder,te as default};
//# sourceMappingURL=i-cal.stories-CWkJUsN2.js.map
