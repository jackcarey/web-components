import{j as e}from"./index-DTcoQwQS.js";import{useMDXComponents as r}from"./index-DDH4e_a9.js";import"./_commonjsHelpers-CqkleIqs.js";function t(n){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"mutative",children:"mutative"}),`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://jackcarey.co.uk/web-components/storybook-static/?path=/docs/utilities-mutative",rel:"nofollow",children:e.jsx(s.img,{src:"https://cdn.jsdelivr.net/gh/storybookjs/brand@main/badge/badge-storybook.svg",alt:"mutative utility on Storybook"})})," ",e.jsx(s.a,{href:"https://jsr.io/@web-components/mutative/versions",rel:"nofollow",children:e.jsx(s.img,{src:"https://jsr.io/badges/@web-components/mutative",alt:"mutative version on JSR"})})," ",e.jsx(s.a,{href:"https://jsr.io/@web-components/mutative/score",rel:"nofollow",children:e.jsx(s.img,{src:"https://jsr.io/badges/@web-components/mutative/score",alt:"JSR score"})})]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsx(s.p,{children:"Persistent DOM mutation observations based on CSS query selectors"}),`
`]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Version:"})," 1.0.3"]}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Browser:"})," via the ESM CDN: ",e.jsx(s.a,{href:"https://esm.sh/jsr/@web-components/mutative",rel:"nofollow",children:"https://esm.sh/jsr/@web-components/mutative"})]}),`
...
`})}),`
`,e.jsx(s.h4,{id:"deno",children:"Deno"}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`deno add jsr:@web-components/mutative
`})}),`
`,e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"NPM:"})," JSR provides ",e.jsx(s.a,{href:"https://jsr.io/docs/npm-compatibility",rel:"nofollow",children:"NPM compatibility"}),". You can install this package with:"]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`npx jsr add @web-components/mutative
`})}),`
`,e.jsx(s.h1,{id:"documentation",children:"Documentation"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsxs(s.strong,{children:["Open examples for ",e.jsx(s.a,{href:"https://jackcarey.co.uk/web-components/storybook-static/?path=/docs/utilities-mutative",rel:"nofollow",children:"mutative on Storybook"})]}),"."]}),`
`]}),`
...
//# sourceMappingURL=mutative-A_noCY1H.js.map
