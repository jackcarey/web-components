...
`]}),`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://jsr.io/@web-components/mutative",rel:"nofollow",children:e.jsx(s.img,{src:"https://jsr.io/badges/@web-components/mutative",alt:"mutative"})})," ",e.jsx(s.a,{href:"https://jsr.io/@web-components/mutative/score",rel:"nofollow",children:e.jsx(s.img,{src:"https://jsr.io/badges/@web-components/mutative/score",alt:"score"})})]}),`
`,e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"version:"})," 1.0.3"]}),`
`,e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"license:"})," ",e.jsx(s.a,{href:"./LICENSE.md",children:"LGPL-3"})]}),`
...
`,e.jsxs(s.li,{children:[e.jsxs(s.strong,{children:["Open ",e.jsx(s.a,{href:"https://jackcarey.co.uk/web-components/storybook-static/?path=/docs/utilities-mutative",rel:"nofollow",children:"mutative on Storybook"})]}),"."]}),`
`]}),`
...
`,e.jsx(s.hr,{}),`
`,e.jsxs(s.p,{children:["Made by ",e.jsx(s.a,{href:"https://jackcarey.co.uk",rel:"nofollow",children:"jackcarey"}),"."]})]})}function l(n={}){const{wrapper:s}={...r(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{l as default};
//# sourceMappingURL=mutative-cHWCce43.js.map
