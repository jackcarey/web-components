import{C as H}from"./utils-Oywqo2Bl.js";import{x as t}from"./iframe-KSbkThoE.js";import"./preload-helper-Dp1pzeXC.js";const O={...H("svg-map"),argTypes:{zoom:{control:{type:"number",min:.5,max:3,step:.5},description:"Current zoom level"},disabled:{control:"boolean",description:"Disable the component"}}},e={args:{zoom:1},render:a=>t`
    <svg-map zoom="${a.zoom}">
...
//# sourceMappingURL=svg-map.stories-BbKhad8w.js.map
