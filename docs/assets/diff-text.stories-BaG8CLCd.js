import{C as ge,a as me}from"./utils-GJDr8CH2.js";import{x as a}from"./iframe-Cf7u7duI.js";import{DiffText as he}from"./index-B6Y7fIAx.js";import"./preload-helper-Dp1pzeXC.js";var x=Object.freeze,pe=Object.defineProperty,de=(e,b)=>x(pe(e,"raw",{value:x(b||e.slice())})),y,C;const S=e=>a`<style>
            diff-text {
                display: block;
        ...
        <b>Args:</b><br />
        <pre>${JSON.stringify(e,null,2)}</pre>`,xe={...ge("diff-text",void 0,{decorators:[...me("diff-text",void 0),e=>(customElements.get("diff-text")||customElements.define("diff-text",he),a`${e()}`)]}),render:S,parameters:{chromatic:{disableSnapshot:!0}}},r={args:{originalSelector:"#original",changedSelector:"#changed"},parameters:{chromatic:{disableSnapshot:!1}}},t={args:{originalSelector:"#original",changedSelector:"#changed",mode:"chars"},parameters:{chromatic:{disableSnapshot:!1}}},n={args:{originalSelector:"#original",changedSelector:"#changed","ignore-case":!0},parameters:{chromatic:{disableSnapshot:!1}}},c={args:{originalSelector:"#original",changedSelector:"#changed",mode:"chars","ignore-case":!0},parameters:{chromatic:{disableSnapshot:!1}}},o={args:{originalSelector:"#original",changedSelector:"#changed",mode:"chars"},render:(e,b)=>{const u=S(e);return a(C||(C=de(["",`
            <script>
...
}`,...(le=(ie=f.parameters)==null?void 0:ie.docs)==null?void 0:le.source}}};const ye=["Default","CompareChars","IgnoreCase","IgnoreCaseChars","WithChangingText","OriginalSrc","ChangedSrc","OriginalAndChangedSrc","Refresh","CompareAttr","Lines","Arrays","Callback","textInput"];export{h as Arrays,p as Callback,i as ChangedSrc,g as CompareAttr,t as CompareChars,r as Default,n as IgnoreCase,c as IgnoreCaseChars,m as Lines,l as OriginalAndChangedSrc,s as OriginalSrc,d as Refresh,o as WithChangingText,ye as __namedExportsOrder,xe as default,f as textInput};
//# sourceMappingURL=diff-text.stories-BaG8CLCd.js.map
