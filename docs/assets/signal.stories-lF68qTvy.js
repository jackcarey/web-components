import r from"./index-jeR3H6yP.js";import{x as v}from"./iframe-BBmmQcdB.js";const O={},a=(o,t,e)=>{const s=`#${`signal-${Math.floor(Math.random()*1e3)}`}`;return v`<div id="${s}"><p>
...
//# sourceMappingURL=signal.stories-lF68qTvy.js.map
