import{C as m,a as f}from"./utils-D7bRovQ2.js";import{x as e}from"./iframe-CHKlN-92.js";import g from"./index-k3KnM4uq.js";const s=e` <style>
    kbd-click {
        display: contents;
    }
    button {
    ...
    kbd:active {
        ...
        </kbd-click>`,x={...m("kbd-click",void 0,{decorators:[...f("kbd-click",void 0),t=>(customElements.get("kbd-click")||customElements.define("kbd-click",g),e`${t()}`)]}),render:v},r={args:{}},o={args:{caseSensitive:!0,filter:"A, B, C"},render:t=>e` ${s}<kbd-click
                ${t.passive?"passive":""}
                ${t.capture?"capture":""}
                ${t.allowRepeat?"allow-repeat":""}
                filter="${t.filter||""}"
...
}`,...(u=(p=n.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};const w=["Basic","CaseSensitive","Filtered"];export{r as Basic,o as CaseSensitive,n as Filtered,w as __namedExportsOrder,x as default};
//# sourceMappingURL=kbd-click.stories-CShhfhhU.js.map
