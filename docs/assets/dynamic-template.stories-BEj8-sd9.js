import{C as f,a as x}from"./utils-C4r0S_fJ.js";import{x as e}from"./iframe-YuY4lExJ.js";import{DynamicTemplate as P}from"./index-BWxOUyKi.js";var l=Object.freeze,H=Object.defineProperty,v=(t,_)=>l(H(t,"raw",{value:l(t.slice())})),s,p;const O={...f("dynamic-template",void 0,{decorators:[...x("dynamic-template",void 0),t=>(customElements.get("blog-post")||customElements.define("blog-post",P),e`${t()}`)]})},S=e(s||(s=v([`<script type="module">
        <\/script>`]))),m=e`
            <blog-post>
...
//# sourceMappingURL=dynamic-template.stories-BEj8-sd9.js.map
