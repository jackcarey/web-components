import r from"./index-jeR3H6yP.js";import{x as v}from"./iframe-qlbfcv1L.js";import"./preload-helper-Dp1pzeXC.js";const H={},a=(o,t,e)=>{const s=`#${`signal-${Math.floor(Math.random()*1e3)}`}`;return v`<div id="${s}"><p>
...
}`,...($=(_=g.parameters)==null?void 0:_.docs)==null?void 0:$.source}}};const M=["Default","WithDocumentTarget","LotsOfProperties","Interval","UseSuffix"];export{i as Default,d as Interval,c as LotsOfProperties,g as UseSuffix,l as WithDocumentTarget,M as __namedExportsOrder,H as default};
//# sourceMappingURL=signal.stories-Dwa_XrZ3.js.map
