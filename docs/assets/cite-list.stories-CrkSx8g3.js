import{C as k,a as M}from"./utils-jhHiPA8M.js";import{x as o}from"./iframe-i4LUE4V3.js";import{CiteList as T}from"./index-BVc3ygFW.js";var s=Object.freeze,$=Object.defineProperty,D=(t,h)=>s($(t,"raw",{value:s(t.slice())})),d;const p=t=>o`<article>
        ...
        ></cite-list>`,N={...k("cite-list",void 0,{decorators:[...M("cite-list",void 0),t=>(customElements.get("cite-list")||customElements.define("cite-list",T),o`${t()}`)]}),render:p},e={args:{selector:"article"}},i={args:{}},n={args:{selector:"article",limit:5}},a={args:{selector:"article",link:!0},render:(t,h)=>{const r=p(t);return o`${r}
            <article>
                <p>
...
}`,...(I=(b=c.parameters)==null?void 0:b.docs)==null?void 0:I.source}}};const F=["ArticleSelector","NoSelector","Limit","Link","ChangingCitations"];export{e as ArticleSelector,c as ChangingCitations,n as Limit,a as Link,i as NoSelector,F as __namedExportsOrder,N as default};
//# sourceMappingURL=cite-list.stories-CrkSx8g3.js.map
