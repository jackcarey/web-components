import{C as Se,a as ye}from"./utils-DEQ7wb9-.js";import{x as t}from"./iframe-qlbfcv1L.js";import{DiffText as Ce}from"./index-B7kHwGis.js";import"./preload-helper-Dp1pzeXC.js";var C=Object.freeze,ke=Object.defineProperty,xe=(e,x)=>C(ke(e,"raw",{value:C(x||e.slice())})),k,w;const y=e=>t`<style>
            diff-text {
                display: block;
...
The quick brown fox jumps over the lazy dog.</textarea
            ...
            ></diff-text>`},u={name:"Content editable (self)",render:()=>t`<style>
                diff-text {
                    display: block;
                    border: 1px solid #ccc;
                    min-height: 1em;
            ...
            ><diff-text
                ...
                id="diff-self"
                original="The quick brown fox jumps over the lazy dog."
                changed-selector="#diff-self"
            ></diff-text>`};var T,v,j;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(v=r.parameters)==null?void 0:v.docs)==null?void 0:j.source}}};var I,O,$;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    originalSelector: "#original",
    changedSelector: "#changed",
    mode: "chars"
...
}`,...(N=(M=i.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};var V,G,H;l.parameters={...l.parameters,docs:{...(V=l.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(H=(G=l.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var K,Q,U;d.parameters={...d.parameters,docs:{...(K=d.parameters)==null?void 0:K.docs,source:{originalSource:`{
...
}`,...(ie=(se=p.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var le,de,ge;f.parameters={...f.parameters,docs:{...(le=f.parameters)==null?void 0:le.docs,source:{originalSource:`{
...
}`,...(ge=(de=f.parameters)==null?void 0:de.docs)==null?void 0:ge.source}}};var me,he,pe;b.parameters={...b.parameters,docs:{...(me=b.parameters)==null?void 0:me.docs,source:{originalSource:`{
  render: () => {
    return html\`<style>
                diff-text {
                    display: block;
...
}`,...(ue=(be=u.parameters)==null?void 0:be.docs)==null?void 0:ue.source}}};const Oe=["Default","CompareChars","IgnoreCase","IgnoreCaseChars","WithChangingText","OriginalSrc","ChangedSrc","OriginalAndChangedSrc","Refresh","CompareAttr","Lines","Arrays","Callback","textInput","ContentEditable","ContentEditableSelf"];export{h as Arrays,p as Callback,i as ChangedSrc,g as CompareAttr,a as CompareChars,b as ContentEditable,u as ContentEditableSelf,r as Default,n as IgnoreCase,c as IgnoreCaseChars,m as Lines,l as OriginalAndChangedSrc,s as OriginalSrc,d as Refresh,o as WithChangingText,Oe as __namedExportsOrder,Ie as default,f as textInput};
//# sourceMappingURL=diff-text.stories-8SBjWj-X.js.map
