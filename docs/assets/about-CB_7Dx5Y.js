import{j as o}from"./index-BFfWjCa1.js";import{useMDXComponents as n}from"./index-Bx0zT03Q.js";import{M as c,c as a}from"./blocks-DQTkq0wA.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-YuY4lExJ.js";const r=`# web-components
...
-   **Information**
    -   There are currently 9 packages in this collection. Some are web components intended for the DOM, others are utilities that components may consume.
...
| [rss-feed](https://jackcarey.co.uk/web-components/docs/?path=/docs/components-rss-feed) | Render RSS feeds in the DOM - **Component** | 0.0.0 | [LGPL-3](https://www.tldrlegal.com/search?query=LGPL-3) | [![rss-feed component on Storybook](https://cdn.jsdelivr.net/gh/storybookjs/brand@main/badge/badge-storybook.svg)](https://jackcarey.co.uk/web-components/docs/?path=/docs/components-rss-feed) [![rss-feed version on JSR](https://jsr.io/badges/@web-components/rss-feed)](https://jsr.io/@web-components/rss-feed/versions) [![JSR score](https://jsr.io/badges/@web-components/rss-feed/score)](https://jsr.io/@web-components/rss-feed/score) |
...
`,o.jsx(a,{children:r})]})}function h(e={}){const{wrapper:t}={...n(),...e.components};return t?o.jsx(t,{...e,children:o.jsx(s,{...e})}):s()}export{h as default};
//# sourceMappingURL=about-CB_7Dx5Y.js.map
