import{C as T,a as S}from"./utils-B3DjrQeb.js";import{x as e}from"./iframe-oxgkRq0W.js";import{DynamicTemplate as f}from"./index-BWxOUyKi.js";var l=Object.freeze,x=Object.defineProperty,P=(t,$)=>l(x(t,"raw",{value:l(t.slice())})),s;const B={...T("dynamic-template",void 0,{decorators:[...S("dynamic-template",void 0),t=>(customElements.get("blog-post")||customElements.define("blog-post",f),e`${t()}`)]})},m=e`
            <blog-post>
  ...
  render: () => html\`
    ...
    \`
}`,...(y=(u=o.parameters)==null?void 0:u.docs)==null?void 0:y.source}}};const O=["CompactTemplate","ImageOnlyTemplate","TemplateSelector"];export{a as CompactTemplate,n as ImageOnlyTemplate,o as TemplateSelector,O as __namedExportsOrder,B as default};
//# sourceMappingURL=dynamic-template.stories-DIlA_SHH.js.map
