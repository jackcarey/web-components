import{C as _,a as C}from"./utils-D0He91_z.js";import{x as e}from"./iframe-CIyiIpLK.js";import{DynamicTemplate as I}from"./index-ZUpbfJB3.js";var s=Object.freeze,B=Object.defineProperty,$=(t,N)=>s(B(t,"raw",{value:s(t.slice())})),p,r;const j={..._("dynamic-template",void 0,{decorators:[...C("dynamic-template",void 0),t=>(customElements.get("blog-post")||customElements.define("blog-post",I),e`${t()}`)]})},a={storyName:"Default (no content)",args:{}},x=e(p||(p=$([`<script type="module">
        <\/script>`]))),l=e`
            <blog-post>
  ...
  render: () => html\`
    ...
    \`
}`,...(T=(f=m.parameters)==null?void 0:f.docs)==null?void 0:T.source}}};const q=["Default","CompactTemplate","ImageOnlyTemplate","TemplateSelector"];export{n as CompactTemplate,a as Default,o as ImageOnlyTemplate,m as TemplateSelector,q as __namedExportsOrder,j as default};
//# sourceMappingURL=dynamic-template.stories-CgHHurRz.js.map
